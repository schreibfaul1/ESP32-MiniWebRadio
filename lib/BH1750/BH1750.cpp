...
// ——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
hp_BH1750::hp_BH1750() { // constructor
...
bool hp_BH1750::setResolutionMode(uint8_t resolutionMode) {
    if (!isInit) return false;
    if (resolutionMode == ONE_TIME_H_RESOLUTION_MODE) {
        m_resolution = 1.0;
        m_measurementTime = 120;
        m_resolutionMode = resolutionMode;
        return true;
    }
    if (resolutionMode == ONE_TIME_H_RESOLUTION_MODE2) {
        m_resolution = 0.5;
        m_measurementTime = 120;
        m_resolutionMode = resolutionMode;
        return true;
    }
    if (resolutionMode == ONE_TIME_L_RESOLUTION_MODE) {
        m_resolution = 4.0;
        m_measurementTime = 16;
        m_resolutionMode = resolutionMode;
        return true;
    }
    return false;
...
// ——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
bool hp_BH1750::begin(TwoWire* myWire, uint8_t address) {
    _wire = myWire;
    _address = address; // Store one of the two available addresses

    isInit = writeMtreg(BH1750_MTREG_DEFAULT); // Set standard sensitivity
    _timeflag = false;
    return isInit;
}
// ——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
...
void hp_BH1750::loop() {
    ...
    if (_timer + 1000 < millis() && _timeflag) {
        ...
        // log_i("lux %i", lux);
        if (on_BH1750) { on_BH1750(static_cast<uint16_t>(lux)); }
    }
}
// ——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
