...
//————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
bool hp_BH1750::begin(byte address, int8_t sda, int8_t scl) {
...
//————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
bool hp_BH1750::writeByte(byte b){  // Sends command to sensor
...
//————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
bool hp_BH1750::writeMtreg(byte mtreg) { // Change sensitivity measurement time
