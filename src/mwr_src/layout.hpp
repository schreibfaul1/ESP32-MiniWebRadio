...
void placingGraphicObjects() { // and initialize them
    ...
    btn_BR_ready.set_bg_color(TFT_BG_VISIBLE);
    ...
    btn_WR_alarm.set_bg_color(TFT_BG_VISIBLE);
    ...
    btn_WR_sleep.set_bg_color(TFT_BG_VISIBLE);
    ...
    btn_WR_radio.set_bg_color(TFT_BG_VISIBLE);
    ...
    btn_WR_mute.set_bg_color(TFT_BG_VISIBLE);
    ...
    btn_WR_off.set_bg_color(TFT_BG_VISIBLE);
