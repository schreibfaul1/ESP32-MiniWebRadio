...
const char index_m_html[] PROGMEM = R"=====(
<!DOCTYPE HTML>
<html>
<head>
...
var trebleDB = ['-40', '-37', '-34', '-31', '-28', '-25', '-22', '-19',
  '-16', '-13', '-10', ' -7', ' -4', '  0', ' +3', ' +6']

var trebleVal = [-40, -37, -34, -31, -28, -25, -22, -19, -16, -13, -10, -7, -4, 0, +3, +6]
...
function handletone (tonectrl) { // Radio: low, band, highPass
...
function handlectrl (id, val) { // Radio: LowPass, BandPass, HighPass 
...
<div id="content" >
  ...
  <div id="preloaded-images">
    ...
    <img src="SD/png/Button_Download_Yellow.png"    width="1" height="1" loading="eager" alt="Image 29" />
     <img src="SD/MiniWebRadioV2.jpg"                width="1" height="1" loading="eager" alt="Image 30" />
  </div>
...
<!--==============================================================================================-->
  <div id="tab-content1">
    <div style="height: 66px; display: flex;">
      <div style="flex: 0 0 210px;">
        <img src="SD/png/Button_Previous_Green.png" alt="previous" onmousedown="this.src='SD/png/Button_Previous_Yellow.png'"
                                                                   onmouseup="this.src='  SD/png/Button_Previous_Green.png'"
                                                                   onclick="socket.send('prev_station'); document.getElementById('resultstr1').value = ''" />
        <img src="SD/png/Button_Next_Green.png" alt="next"         onmousedown="this.src='SD/png/Button_Next_Yellow.png'"
                                                                   onmouseup="this.src='  SD/png/Button_Next_Green.png'"
                                                                   onclick="socket.send('next_station'); document.getElementById('resultstr1').value = ''" />
      </div>
      <div style="flex:1;">
    ...
    <div style="height: 146px; display: flex;">
      <div style="flex: 0 0 210px;">
    ...
    <div style="height: 66px; display: flex;">
      <div style="flex: 0 0 210px;">
        <img src="SD/png/Button_Volume_Down_Blue.png" alt="Vol_down" onmousedown="this.src='SD/png/Button_Volume_Down_Yellow.png'" 
                                                                     onmouseup="this.src='SD/png/Button_Volume_Down_Blue.png'"
                                                                     onclick="httpGet('downvolume', 1)" />
        <img src="SD/png/Button_Volume_Up_Blue.png" alt="Vol_up"     onmousedown="this.src='SD/png/Button_Volume_Up_Yellow.png'"
                                                                     onmouseup="this.src='SD/png/Button_Volume_Up_Blue.png'" 
                                                                     onclick="httpGet('upvolume', 1)" />
        <img id="Mute" src="SD/png/Button_Mute_Green.png" alt="Mute" onmousedown="this.src='SD/png/Button_Mute_Yellow.png'" 
  ...
  <div id="tab-content4">
      ...
      <div style="display: flex;">
        <div style="flex: 0 0 130px; padding 1px 5px 5px 1px; ">
          <canvas id="canvas" width="128" height="128" class="playable-canvas"></canvas>
        </div>
        <div style="flex: 1;">
          <div style="flex: 1; height: 38px; padding-top: 14px; padding-left: 10px;">
  ...
  <div id="tab-content5">
    ...
    <img src="SD/MiniWebRadioV2.jpg" alt="MiniWebRadioV2" border="3">
    <h3>Connected WiFi network
      <select class="boxstyle" style="width: 280px"; onchange="handletone(this)" id="ssid"></select>
    </h3>
  </div>
  <!--==============================================================================================-->
</div>
